...
function Word:cond()
    return bit32.extract(self.bits, const.ARM_COND_SHIFT, const.ARM_COND_WIDTH)
end

function Word:op1()
    return bit32.extract(self.bits, const.ARM_OP1_SHIFT, const.ARM_OP1_WIDTH)
end

function Word:op()
    return bit32.extract(self.bits, const.ARM_OP_SHIFT, const.ARM_OP_WIDTH)
end
